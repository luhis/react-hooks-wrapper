...
export const ReconstituteFunctionComponent: <TFinal extends TOther, TOther extends {}, TDontCare extends {}>
    (props: Omit<TFinal, keyof (TOther)> & TDontCare & { children?: ReactNode }, other: TOther) => TFinal =
    <TFinal extends TOther, TOther extends {}, TDontCare extends {}>
